...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "foo@example.com:hello", "bar@example.com:world", "a@a.a:aaaa"
    };
    /**
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            mPasswordView.setText(""); // security reasons
    ...
    private class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(final String success) {
            ...
            if (success == null){
                Log.e("***UserLoginTask", "Didn't receive any data from server!");
                Toast.makeText(getApplicationContext(),
                        "Server unreachable!", Toast.LENGTH_LONG).show();
            }else{
                String s = success.trim();
